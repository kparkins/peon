...
Peon::GLGammaRamp::GLGammaRamp(const GLFWgammaramp* gammaRamp) {
	...
	std::memcpy(static_cast<void*>(&mRed[0]), static_cast<void*>(gammaRamp->red), gammaRamp->size);
	std::memcpy(static_cast<void*>(&mGreen[0]), static_cast<void*>(gammaRamp->green), gammaRamp->size);
	std::memcpy(static_cast<void*>(&mBlue[0]), static_cast<void*>(gammaRamp->blue), gammaRamp->size);
}